                                    ...
                                    .setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                ...
                                                smsManager.setSendSmsPermission(smsManager.askPermissionAndSendSMS());
                                                SmsManager.smsSenderChalkItDown(smsManager.getSendSmsPermission(), user.tel, user.phonecodevalidation);
